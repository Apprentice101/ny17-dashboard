# NY-17 Voting Procedures Dashboard

NY-17 (Mike Lawler R-inc vs 5-way D primary June 23, Cait Conley frontrunner)
...
```bash
# In Apprentice101/ny17-dashboard repo:
git add .
git commit -m "Deploy NY-17 dashboard"
